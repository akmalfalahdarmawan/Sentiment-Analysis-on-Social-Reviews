...
def load_artifact():
    ...
    candidates = [
        here / "sentiment_pipeline_group.joblib",          # root yang sama dengan app.py
        here / "sentiment_pipeline.joblib",                 # nama alternatif
    ...
    meta = art.get("meta", {})
    thr_hr  = meta.get("neg_threshold_hr", 0.20)  # kalau kamu punya profil HR
    thr_bal = meta.get("neg_threshold", 0.40)     # default balanced
